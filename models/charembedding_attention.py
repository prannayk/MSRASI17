...
class embeddingCoder():
	...
	def build_model(self):
		with tf.device("/gpu:0"):
			...
			normalized_embeddings_word = tf.stack([[self.word_embeddings / norm]*word_max_len]*batch_size)
			...
			return optimizer, loss, train_words, train_chars, valid_words, valid_chars, similarity
